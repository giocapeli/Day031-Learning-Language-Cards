...
def get_random_word():
    with open(f"./language-files/{LANGUAGE}-english.json") as data_file:
        ...
        print(data[LANGUAGE][random.randint(0, len(data[LANGUAGE]) -1)])
...
# --- Text
card.create_text(400, 150, text="Language", font=("Ariel", 30, "italic"))
card.create_text(400, 263, text="Word", font=("Ariel", 50, "bold"))
